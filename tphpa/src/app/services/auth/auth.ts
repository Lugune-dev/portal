...
export class AuthService {
  ...
  login(email: string, password: string): Observable<any> {
    return this.http.post(`${this.apiUrl}https://portal-api-z927.onrender.com/login`, { email, password }).pipe(
      tap((response: any) => {
  ...
  forgotPassword(email: string): Observable<any> {
    return this.http.post(`${this.apiUrl}https://portal-api-z927.onrender.com/forgot-password`, { email });
  }

  changePassword(currentPassword: string, newPassword: string): Observable<any> {
    return this.http.post(`${this.apiUrl}https://portal-api-z927.onrender.com/change-password`, { currentPassword, newPassword });
  }
}
